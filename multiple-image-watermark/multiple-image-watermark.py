...
logo = cv2.imread("mylogo.png") #your logo for watermarked
h_logo, w_logo, _ = logo.shape

images_path = glob.glob("images/*.*") #image folder for all images which will be marked with watermaked
...
print("Watermakred Added All Images")